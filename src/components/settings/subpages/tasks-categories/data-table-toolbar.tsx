...
import { TaskCategoryCreateDialog } from "./tasks-category-create-dialog";
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        <Input
          placeholder={t("settings.categories.filter.placeholder")}
        ...
        {isFiltered && (
          ...
          >
            {t("settings.categories.filter.reset")}
